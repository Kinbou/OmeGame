      ...
      if (favorites.length > 0) {
        ...
        for (favorite of favorites) {
          ...
          const mailOptions = {
            ...
            html: `Bonjour ${favorite.user.username}.<br>L'offre ${offer.title} est maintenant disponible. Retrouvez tous les détails de l'offre en cliquant sur le lien suivant : http://ec2-3-83-53-10.compute-1.amazonaws.com/recherche/jeux/${offer.gameId}/${slugTitle}.<br><br>.A bientôt !<br>L'équipe O'meGame`, // plain text body
          };
