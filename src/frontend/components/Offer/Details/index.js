          ...
          <div className="offer-detail__global">
            <div className="offer-detail__left">
              ...
              <section className="offer-detail__left__user">
                <div>
                  {(offer.user.picture === '' || offer.user.picture === null) ? <div className="default-user-image"><i className="fas fa-user" /></div> : <img className="user-picture" src={`http://ec2-3-83-53-10.compute-1.amazonaws.com/images/users/${offer.user.picture}`} alt="" />}
                </div>
            ...
            <div className="offer-detail__right">
              <img className="offer-detail__right__image" src={(offer.image !== null && offer.image !== '') ? `http://ec2-3-83-53-10.compute-1.amazonaws.com/images/offers/${offer.image}` : noimage} alt="" />
