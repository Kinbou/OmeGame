                ...
                <li className="reservations__container" key={reservation.id}>
                  <div className="reservations__container__item">
                    <div className="reservations__container__item__left">
                      <img className="reservations__container__item__left__picture" src={reservation.offer.image === null ? noimage : `http://ec2-3-83-53-10.compute-1.amazonaws.com/images/offers/${reservation.offer.image}`} alt="" />
