            ...
            {data.map((offer) => (
              <li className="accountOffers__listOffers__offer" key={offer.id}>
                <div className="accountOffers__listOffers__offer__left">
                  <img className="accountOffers__listOffers__offer__left__picture" src={offer.image === null ? noimage : `http://ec2-3-83-53-10.compute-1.amazonaws.com/images/offers/${offer.image}`} alt="erreur" />
